...
The automated suite covers human-readable API errors, SSRF/private-URL rejection, PDF/TXT/ZIP packaging, slide-vs-scene classification, and a no-audio natural-scene video that must return zero slides.
