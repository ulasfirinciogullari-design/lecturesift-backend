...
RETIRED_PAGE_COPY = frozenset({
    "Abonelik iptali",
    "Otomatik yenilenen planlar etkinleştirildiğinde, hesabından gelecek yenilemeyi durdurabileceksin. İptal, aksi açıkça belirtilmedikçe mevcut ödenmiş dönemin sonuna kadar erişimi korur ve sonraki dönemi tahsil etmez.",
    "Bu sözleşme, LectureSift üzerinden satın alınan abonelik ve tek kullanımlık dakika paketlerinin uzaktan satış koşullarını düzenler. Sipariş ekranında gösterilen plan, dönem, toplam tutar ve kullanıcı bilgileri bu sözleşmenin ayrılmaz parçasıdır.",
    "Dijital hizmet, başarılı ödeme doğrulamasından ve alıcının cayma süresi dolmadan ifaya başlanmasını açıkça talep etmesinden sonra kullanıcı hesabına tanımlanır. Abonelik erişimi sipariş özetinde belirtilen dönem boyunca, tek seferlik dakika paketi ise hesaba tanımlanan kullanım kredisi tükenene veya açıklanan geçerlilik süresi sona erene kadar kullanılabilir.",
    "Abonelik yenilemesi etkinse kullanıcı gelecek yenilemeyi hesabından durdurabilir. Aksi açıkça belirtilmedikçe iptal, mevcut ödenmiş dönemin sonuna kadar erişimi korur. Ayıplı, eksik veya teknik olarak sunulamayan hizmetlerde emredici tüketici hakları saklıdır.",
    "Planın dakika, quiz, bilgi kartı, dışa aktarma ve saklama hakları satın alma ekranında gösterilir. Vergiler, yenileme şekli ve toplam tutar ödeme öncesinde açıklanır. Yerel para birimindeki sitede gösterilen fiyatlar bilgilendirme amaçlıdır; ödeme kuruluşunun onay ekranındaki kesin tutar esas olur. Ücretli abonelikler ödeme altyapısı etkinleştirilmeden başlatılmaz.",
    "Kart numarası, CVV ve kart parolası LectureSift sunucularında saklanmaz; kartlı ödeme açıldığında bu veriler yetkili ödeme kuruluşunun güvenli ekranında işlenir.",
    "Veriler; kayıt, giriş, hesap ayarı, dosya yükleme, ödeme ve destek formları aracılığıyla elektronik ortamda doğrudan kullanıcıdan; kullanım sırasında otomatik olarak uygulama, barındırma ve güvenlik sistemlerinden; ödeme açıldığında banka veya ödeme kuruluşundan sınırlı ödeme durumu bilgisi olarak elde edilir. Otomatik olmayan yöntemle alınan destek veya finans kayıtları bir veri kayıt sisteminin parçası olduğunda KVKK kapsamındadır.",
    "Veriler; kayıt, giriş, hesap ayarı, dosya yükleme, bağlantı ekleme, ödeme ve destek formları aracılığıyla elektronik ortamda doğrudan kullanıcıdan; kullanım sırasında otomatik olarak uygulama, barındırma ve güvenlik sistemlerinden; ödeme açıldığında banka veya ödeme kuruluşundan sınırlı ödeme durumu bilgisi olarak elde edilir. Otomatik olmayan yöntemle alınan destek veya finans kayıtları bir veri kayıt sisteminin parçası olduğunda KVKK kapsamındadır.",
    "Güncel temel hizmet sağlayıcıları: Render (backend, worker, veritabanı ve kuyruk), Netlify (web dağıtımı), Cloudflare R2 (özel dosya deposu), OpenAI (yapay zekâ işleme), Resend (işlemsel e-posta), iyzico/PayTR (etkin ödeme kuruluşları) ve kullanıcı izniyle etkinleştirildiğinde Google ölçüm/reklam hizmetleridir.",
    "Bu sayfa genel bilgilendirme ve ürün taslağıdır; işletmenin gerçek faaliyeti, sözleşmeleri ve veri akışları bir hukuk uzmanı tarafından doğrulanmalıdır.",
    "Netlify, Render, alan adı/DNS, e-posta, ağ güvenliği ve ileride ödeme sağlayıcıları; hizmeti ulaştırmak, oturum güvenliği, yük dengeleme, dolandırıcılık ve kötüye kullanım önleme amacıyla zorunlu teknik kayıtlar kullanabilir. Adları ve süreleri sağlayıcının yapılandırmasına göre değişebilir. LectureSift bu kayıtları reklam profili oluşturmak için kullanmaz.",
    "Instagram gibi dış sitelere gittiğinde ilgili sitenin kendi çerez ve gizlilik politikası uygulanır. Kartlı ödeme açıldığında ödeme kuruluşunun güvenli ekranındaki zorunlu güvenlik kayıtları da kuruluşun politikasına tabi olur; LectureSift tam kart numarası ve CVV saklamaz.",
    "Son güncelleme: 28 Ağustos 2026",
    "Son güncelleme: 12 Eylül 2026 · Sürüm 2.3",
    "Sürüm: MSS-2026-08-28-v1",
    "Sürüm: MSS-2026-09-12-v2",
    "Son güncelleme: 27 Ağustos 2026",
    "Son güncelleme: 27 Ağustos 2026 · Sürüm 2.0",
    "Son güncelleme: 27 Ağustos 2026 · Sürüm 2.1",
    "Son güncelleme: 28 Ağustos 2026 · Sürüm 2.2",
    "Son güncelleme: 29 Ağustos 2026 · Sürüm 2.1",
    "Bu çerçeve metin 28 Ağustos 2026 tarihinde yayımlanmıştır. Sipariş anında geçerli sözleşme sürümü, ön bilgilendirme onayı ve sipariş özeti elektronik kayıtla ilişkilendirilir. Kullanıcı bu sayfayı yazdırabilir veya tarayıcısından PDF olarak kaydedebilir. Esaslı değişiklikler geçmiş siparişlere geriye yürütülmez.",
    "Havale ödemeleri ödeme kontrolünden sonra etkinleştirilir. PayTR açıldığında kart ve otomatik yenileme eklenecek.",
    "Havale şu anda kullanılabilir. Kart ve yerel ödeme seçenekleri PayTR etkinleştirildiğinde burada açılacak.",
    "Kartlı ödeme PayTR bağlandığında açılacak. TRY havale siparişleri ödeme kontrolünden sonra etkinleşir.",
    "PayTR mağaza onayı ve anahtarları tamamlandığında güvenli ödeme açılacak.",
    "Güncel temel hizmet sağlayıcıları: Render (backend/veritabanı), Netlify (web dağıtımı), OpenAI (yapay zekâ işleme) ve etkinleştirildiğinde Resend (işlemsel e-posta) ile PayTR/ilgili ödeme kuruluşudur.",
    "Gerçek ödeme başlamadan önce sağlayıcı unvanı, adresi, telefon bilgisi, toplam fiyat/vergi, ödeme yöntemi, hizmet başlangıcı, cayma şartları ve başvuru yolu siparişten hemen önce ayrıca gösterilmelidir.",
    "Bu aydınlatma, lecturesift.com alan adı ve LectureSift hizmetleri üzerinden yürütülen kişisel veri işleme faaliyetlerini kapsar. KVKK bakımından veri sorumlusu, hizmetin amaç ve araçlarını belirleyen gerçek veya tüzel kişidir. Resmî kimlik ve iletişim bilgileri işletme kuruluşu kesinleştiğinde bu bölümde açık biçimde yayımlanacaktır. Başvurular geçici olarak",
    "Canlı satış öncesi tamamlanması zorunludur:",
    "Veri sorumlusunun resmî gerçek/tüzel kişi unvanı, açık tebligat adresi, doğrulanmış e-posta adresi, varsa MERSİS/vergi/sicil bilgileri kesinleşmeden bu metin taslak niteliğindedir. Bu alanlar doldurulmadan ücretli satış ve herkese açık kayıt açılmamalıdır.",
})
...
CURATED_TRANSLATIONS = {
    **SENSITIVE_TRANSLATIONS,
    "Planlar’da devam et": ["Planlar’da devam et", "Continue in Plans", "Weiter zu den Tarifen", "Continuer dans les forfaits", "Continuar en Planes", "Continua nei piani", "Continuar nos planos", "Продолжить в тарифах", "المتابعة في الخطط", "在套餐页面继续", "プランページで続ける", "요금제 페이지에서 계속", "प्लान पेज पर जारी रखें"],
    ...
    "Bu sözleşme, LectureSift üzerinden satın alınan 30 veya 365 günlük sabit dönemli planların ve tek seferlik ek dakika paketlerinin uzaktan satış koşullarını düzenler. Sipariş ekranında gösterilen plan, dönem, toplam tutar ve kullanıcı bilgileri bu sözleşmenin ayrılmaz parçasıdır.": ["Bu sözleşme, LectureSift üzerinden satın alınan 30 veya 365 günlük sabit dönemli planların ve tek seferlik ek dakika paketlerinin uzaktan satış koşullarını düzenler. Sipariş ekranında gösterilen plan, dönem, toplam tutar ve kullanıcı bilgileri bu sözleşmenin ayrılmaz parçasıdır.", "This agreement governs the distance-sale terms for 30- or 365-day fixed-term plans and one-time additional-minute packages purchased through LectureSift. The plan, term, total amount, and user information shown at checkout form an integral part of this agreement.", "Diese Vereinbarung regelt die Fernabsatzbedingungen für über LectureSift erworbene Pläne mit einer festen Laufzeit von 30 oder 365 Tagen sowie für einmalig erworbene Zusatzminutenpakete. Der auf der Bestellseite angezeigte Plan, die Laufzeit, der Gesamtbetrag und die Nutzerangaben sind Bestandteil dieser Vereinbarung.", "Le présent contrat régit les conditions de vente à distance des forfaits à durée déterminée de 30 ou 365 jours et des lots de minutes supplémentaires à paiement unique achetés via LectureSift. Le forfait, la durée, le montant total et les informations de l’utilisateur affichés sur l’écran de commande font partie intégrante du contrat.", "Este contrato regula las condiciones de venta a distancia de los planes de duración fija de 30 o 365 días y de los paquetes de minutos adicionales de pago único adquiridos a través de LectureSift. El plan, el período, el importe total y la información del usuario mostrados en la pantalla de pedido forman parte integrante del contrato.", "Il presente contratto disciplina le condizioni di vendita a distanza dei piani a durata fissa di 30 o 365 giorni e dei pacchetti di minuti aggiuntivi con pagamento unico acquistati tramite LectureSift. Il piano, la durata, l’importo totale e i dati dell’utente mostrati nella schermata dell’ordine sono parte integrante del contratto.", "Este contrato rege as condições de venda à distância dos planos com prazo fixo de 30 ou 365 dias e dos pacotes de minutos adicionais de pagamento único adquiridos pelo LectureSift. O plano, o período, o valor total e as informações do usuário exibidos na tela do pedido fazem parte integrante do contrato.", "Настоящий договор регулирует условия дистанционной продажи планов с фиксированным сроком 30 или 365 дней и разовых пакетов дополнительных минут, приобретаемых через LectureSift. План, срок, общая сумма и данные пользователя, показанные на экране заказа, являются неотъемлемой частью договора.", "ينظم هذا العقد شروط البيع عن بُعد للخطط ذات المدة الثابتة البالغة 30 أو 365 يومًا وباقات الدقائق الإضافية ذات الدفع لمرة واحدة التي تُشترى عبر LectureSift. وتُعد الخطة والمدة والمبلغ الإجمالي ومعلومات المستخدم المعروضة في شاشة الطلب جزءًا لا يتجزأ من العقد.", "本协议规定通过 LectureSift 购买的30天或365天固定期限套餐及一次性额外分钟包的远程销售条款。订单页面显示的套餐、期限、总金额和用户信息均为本协议不可分割的组成部分。", "本契約は、LectureSiftを通じて購入される30日または365日の固定期間プランおよび一回払いの追加処理時間パックに関する通信販売条件を定めます。注文画面に表示されるプラン、期間、合計金額、ユーザー情報は、本契約の不可分の一部を構成します。", "본 계약은 LectureSift를 통해 구매하는 30일 또는 365일 고정 기간 요금제와 일회성 추가 이용 시간 패키지의 통신판매 조건을 규정합니다. 주문 화면에 표시되는 요금제, 기간, 총액 및 사용자 정보는 본 계약의 필수적인 부분입니다.", "यह अनुबंध LectureSift के माध्यम से खरीदे गए 30 या 365 दिनों के निश्चित-अवधि प्लान और एकमुश्त अतिरिक्त मिनट पैकेज की दूरस्थ बिक्री की शर्तें तय करता है। ऑर्डर स्क्रीन पर दिखाए गए प्लान, अवधि, कुल राशि और उपयोगकर्ता की जानकारी इस अनुबंध का अभिन्न भाग हैं।"],
...
def write_catalog(path: Path, catalog: dict[str, list[str]]) -> None:
    ordered = {}
    for key in sorted((key for key in catalog if key not in RETIRED_PAGE_COPY), key=str.casefold):
