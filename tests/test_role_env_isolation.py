...
def _runtime_fixture(tmp_path: Path) -> Path:
    ...
    assignments = {
        ...
        "LECTURESIFT_ADSENSE_API_CLIENT_ID": "123-example.apps.googleusercontent.com",
        "LECTURESIFT_ADSENSE_API_CLIENT_SECRET": "adsense-client-secret",
        "LECTURESIFT_ADSENSE_API_REFRESH_TOKEN": "adsense-refresh-token",
        "LECTURESIFT_ADSENSE_API_ACCOUNT_NAME": "accounts/pub-1234567890",
        "LECTURESIFT_ADSENSE_API_SITE_DOMAIN": "example.test",
        "LECTURESIFT_ADSENSE_API_CACHE_SECONDS": "300",
        "LECTURESIFT_ADSENSE_API_TIMEOUT_SECONDS": "10",
        "LECTURESIFT_GOOGLE_ADS_API_ENABLED": "false",
        "LECTURESIFT_GOOGLE_ADS_API_SERVICE_ACCOUNT_JSON": "google-ads-service-account-secret",
        "LECTURESIFT_GOOGLE_ADS_API_CUSTOMER_ID": "1234567890",
...
def test_worker_and_instagram_roles_are_exact_least_privilege(tmp_path: Path):
    ...
    forbidden_worker = {
        ...
        "IYZICO_API_KEY",
        "IYZICO_SECRET_KEY",
        "LECTURESIFT_ADSENSE_API_ENABLED",
        ...
        "LECTURESIFT_ADSENSE_API_CACHE_SECONDS",
        "LECTURESIFT_ADSENSE_API_TIMEOUT_SECONDS",
        "LECTURESIFT_GOOGLE_ADS_API_ENABLED",
        "LECTURESIFT_GOOGLE_ADS_API_SERVICE_ACCOUNT_JSON",
        "LECTURESIFT_GOOGLE_ADS_API_CUSTOMER_ID",
        "LECTURESIFT_GOOGLE_ADS_API_CACHE_SECONDS",
        "LECTURESIFT_GOOGLE_ADS_API_TIMEOUT_SECONDS",
        "PAYTR_MERCHANT_KEY",
        "EMAIL_PROVIDER",
        "RESEND_API_KEY",
        "SMTP_PASSWORD",
