...
<html lang="{html.escape(language[:2] or 'tr')}">
  <body style="margin:0;background:#061022;padding:28px;font-family:Inter,Arial,sans-serif;color:#f7f9ff">
    <div style="max-width:560px;margin:0 auto;border:1px solid #203455;border-radius:22px;background:#0d1c38;padding:32px;box-shadow:0 24px 70px rgba(0,0,0,.28)">
      ...
      <div style="margin:26px 0;padding:20px;text-align:center;border:1px solid #31598c;border-radius:16px;background:#08162d;color:#ffffff;font-size:34px;font-weight:900;letter-spacing:10px">{safe_code}</div>
