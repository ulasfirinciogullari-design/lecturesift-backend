...
five completed cards to the sixth card. Marker checks keep retries idempotent,
...
def main() -> int:
    _write_status({"status": "waiting", "target_index": 6})
    time.sleep(30)
