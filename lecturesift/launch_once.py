...
six completed cards to the seventh card. Marker checks keep retries idempotent,
...
_EXPECTED_COMPLETED = [1, 2, 3, 4, 5, 6]
...
def main() -> int:
    _write_status({"status": "waiting", "target_index": 7})
    time.sleep(30)
